	...
	<div id='filtro' class='hidden draggableDialog'>
		...
		<div>
			...
			<select id='inputBuscarTipoOperacion' class='textbox filtroBuscar w220'>
				...
				<option value='2'>Confirmación de stock</option>
				<option value='3'>Remito</option>
				<option value='4'>Nota de crédito</option>
				<option value='5'>Mov. de almacén</option>
			</select>
		</div>
		<div>
		...
		<div>
			...
			<select id='inputOrden' class='textbox filtroBuscar w220'>
				...
				<option value='2'>Almacén-artículo ascendente</option>
				<option value='3'>Almacén-artículo descendente</option>
