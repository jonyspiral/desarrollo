...
<div id="cabecera">
	<div id="c1" class="absolute">
		<p class="textoSpiral"><b>ENCINITAS S.A.S</b></p>
	...
	<div id="c3">
		...
		<span id="numerosCabecera" class="textoSize07 absolute">C.U.I.T Nº <?php echo Funciones::ponerGuionesAlCuit(Config::CUIT_NCNTS); ?><BR/>ING. BRUTOS Nº <?php echo Funciones::ponerGuionesAlCuit(Config::CUIT_NCNTS); ?><BR/>INICIO DE ACTIVIDADES: 04/2007</span>
	</div>
</div>
