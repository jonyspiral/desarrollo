<?php require_once('../../../../premaster.php'); if (Usuario::logueado()->puede('produccion/stock_mp/confirmacion_movimiento_almacen/borrar/')) { ?>
<?php
...
try {
	...
	$movimiento->borrar()->notificar('produccion/stock_mp/confirmacion_movimiento_almacen/borrar/');
