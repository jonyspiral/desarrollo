<?php require_once('../../../../../premaster.php'); if (Usuario::logueado()->puede('administracion/tesoreria/gastos/aplicacion/borrar/')) { ?>
<?php
...
try {
	$hija = Factory::getInstance()->getDocumentoProveedorHija($id);
	$hija->desaplicar();
