<?php require_once('../../../premaster.php'); if (Usuario::logueado()->puede('sistema/indicadores/editar/')) { ?>
<?php
...
try {
	...
	$indicador->guardar()->notificar('sistema/indicadores/editar/');
