...
<script type='text/javascript'>
	var opciones = [
		...
		{'id': 'devolucion', 'nombre': 'Por devolución'},
		{'id': 'generica', 'nombre': 'Ajuste', 'tipo': 'NCA'},
		{'id': 'generica', 'nombre': 'Comercial', 'tipo': 'NCC'},
		{'id': 'generica', 'nombre': 'Financiera', 'tipo': 'NCF'},
		{'id': 'garantia/normal', 'nombre': 'Garantía normal'},
		{'id': 'garantia/ecommerce', 'nombre': 'Garantía ecommerce'}
	];

	$(document).ready(function(){
		tituloPrograma = 'Generación de notas de crédito';
		cambiarModo('inicio');
