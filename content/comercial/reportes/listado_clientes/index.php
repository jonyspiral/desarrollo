...
<script type='text/javascript'>
	$(document).ready(function(){
		tituloPrograma = 'Listado clientes';
		cambiarModo('inicio');
	});
	...
	function buscar() {
		...
		funciones.load($('#divListadoClientes'), url, function() {
			$('#divListadoClientes').fixedHeader({target: 'table'});
...
<div id='programaContenido' class='customScroll'>
	<div id='divListadoClientes' class='w100p customScroll'></div>
</div>
<div id='programaPie'>
	<div id='filtro' class='draggableDialog hidden'>
		...
		<div>
			<label for='inputVendedor' class='filtroBuscar'>Vendedor:</label>
			<input id='inputVendedor' class='textbox autoSuggestBox filtroBuscar w200' name='Vendedor' />
		</div>
		<div>
