<?php require_once('../../../../../premaster.php'); if (Usuario::logueado()->puede('administracion/cobranzas/ingresos/recibos/borrar/')) { ?>
<?php

$idRecibo = Funciones::post('idRecibo');
...
try {
	...
	if ($rec->esEcommerce()) {
		throw new FactoryExceptionCustomException('No se puede borrar un recibo de ecommerce');
	}
