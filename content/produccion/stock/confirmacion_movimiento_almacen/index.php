...
<script type='text/javascript'>
	$(document).ready(function(){
		tituloPrograma = 'Confirmación de movimientos de almacén PT';
		cambiarModo('inicio');
	});
...
<div id='programaPie'>
	<div id='filtro' class='draggableDialog hidden'>
		...
		<div>
			<label for='inputBuscarMotivo' class='filtroBuscar'>Motivo:</label>
			<input id='inputBuscarMotivo' class='textbox filtroBuscar w220' />
		</div>
		<div>
