<?php require_once('../../../premaster.php'); if (Usuario::logueado()->puede('abm/sucursales/agregar/')) { ?>
<?php


$idClienteAdd = Funciones::post('idClienteAdd');//agregado porque el id de cliente no viene de inputBuscarCliente
$nombre = Funciones::post('nombre');
$telefono1 = Funciones::post('telefono1');
$telefono2 = Funciones::post('telefono2');
$celular1 = Funciones::post('celular');
...
try {
	...
	$sucursal->sucursalEntrega = Factory::getInstance()->getSucursal($idProveedor, $idSucursalEntrega);
	...
	$sucursal->guardar()->notificar('abm/sucursales/agregar/');
