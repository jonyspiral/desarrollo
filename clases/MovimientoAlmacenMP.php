...
/**
 * @property MovimientoAlmacenConfirmacionMP	$confirmacion
...
class MovimientoAlmacenMP extends Base implements OperacionStock {
	...
	public function stockTipoOperacion() {
		return TiposOperacionStockMP::movimientoAlmacen;
	}
	...
	public function stockObservacion() {
		return 'Mov. almacén MP Nº ' . $this->id;
	}
