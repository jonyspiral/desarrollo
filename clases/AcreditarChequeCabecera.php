...
class AcreditarChequeCabecera extends AcreditarDebitarChequeCabecera {
	...
	protected function getDetalle() {
		if (!isset($this->_detalle) && isset($this->numero)){
			$this->_detalle = Factory::getInstance()->getListObject('AcreditarCheque', 'empresa = ' . Datos::objectToDB($this->empresa) . ' AND cod_deposito_cheque = ' . Datos::objectToDB($this->numero));
		}
